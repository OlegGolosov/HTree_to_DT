...
{
	enum eTriggers {  // all bits evaluate good
		kGoodVertexClust = 0,        // 1: 1     good cluster vertex   (chi2>0, z > -65 (apr12), -160 (Jul14+aug14)) (requires 1 track)
		kGoodVertexCand,        // 2: 2     good candidate vertex (chi2>0, z > -65 (apr12), -160 (Jul14+aug14)) (requires at least 2 reconstructed particles)
		...
		kNoPileUpMDC,        // 6: 32    no pileup in MDC   (objects t1>200 (inner or t1>400 (outer)), threshold 7 (pionbeam) 35 (apr12))
